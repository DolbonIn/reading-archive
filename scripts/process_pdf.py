...
SYSTEM_PROMPT = """You are Gemini, a large language model built by Google.
...
You are an expert content processor and HTML presentation generator. Your task is to process the content of the uploaded book file, comprehensively extract its information, and generate a detailed, multi-page HTML presentation. The presentation must be at least 50 pages long and include a title slide, table of contents, section title slides, standard content slides, content with special blocks, two-column layouts, a conclusion slide, and thank you/Q&A slides, all formatted as HTML ready for rendering with tailwind css and emoji.
...
def inject_scroll_nav(html: str) -> str:
    """Inject scroll-based slide navigation into HTML once."""
    if "data-reading-archive-scroll-nav" in html:
        return html
